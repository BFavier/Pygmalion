...
class Batchifyer:
    ...
    def __init__(self, n_batches: int, batch_size: int):
        self.data_generator = OrbitalTrajectoryGenerator(n_batches=n_batches, batch_size=batch_size, dt_min=1.0E-8)
...
train_losses, val_losses, grad, best_step = model.fit(batchifyer, val_data, n_steps=1_000, keep_best=False, learning_rate=1.0E-4)
